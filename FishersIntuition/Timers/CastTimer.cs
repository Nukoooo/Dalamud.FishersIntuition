...
internal partial class Timers
{
    ...
    [Signature("40 55 56 57 41 54 41 55 41 57 48 8D 6C 24", DetourName = nameof(hk_ProcessSystemLogMessagePacket))]
    private Hook<ProcessSystemLogMessagePacketDelegate> ProcessSystemLogMessagePacketHook { get; init; } = null!;

    // ReSharper disable once AutoPropertyCanBeMadeGetOnly.Local
    [Signature("48 89 5C 24 ?? 57 48 83 EC ?? 8B 81 ?? ?? ?? ?? 41 0F B7 F9",
